...
public class ViewFlowerTop extends View {
	
	private Paint mainPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
	private Paint mainText = new Paint(Paint.ANTI_ALIAS_FLAG);
	
	public ViewFlowerTop(Context context) {
		super(context);
		initView(context);
	}

	public ViewFlowerTop(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public ViewFlowerTop(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}
	
	private OnFlowerBackListener listener;
	public interface OnFlowerBackListener{
		public void OnFlowerBackListener();
	}
	public void setOnFlowerBackListener(OnFlowerBackListener listener){
	...
	private void initView(Context context) {
		drawBackgroud = getResources().getDrawable(R.drawable.shape_block_flower_top);
		titleButton = getResources().getString(R.string.tanghoa);
	...
	public void setNameDevice(String namedevice){
		MyLog.e("ViewFlowerTop", "namedevice : " + namedevice);
