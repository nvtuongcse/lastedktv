...
package com.midi.event;

import java.io.IOException;
import java.io.InputStream;
import java.io.OutputStream;

import com.midi.event.meta.MetaEvent;
...
public abstract class MidiEvent implements Comparable<MidiEvent>
{
    ...
    {
        return "" + mTick + "<>" + mMiliSecond + " (" + mDelta.getValue() + "): " + this.getClass().getSimpleName();
    }
    
	protected long mMiliSecond;
	public void setTickInMs(long ms) {
		mMiliSecond = ms; 
	}
	
	public long getTickInMs()
	{
		return mMiliSecond; 
	}
}
