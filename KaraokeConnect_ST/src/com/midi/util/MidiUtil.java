...
public class MidiUtil
{
     ...
     */
    public static double ticksToMs(long ticks, int mpqn, int resolution)
    {
        return (((double)ticks * mpqn) / resolution) / 1000;
    }

    public static double ticksToMs(long ticks, float bpm, int resolution)
    {
        return ticksToMs(ticks, bpmToMpqn(bpm), resolution);
    }

    public static long msToTicks(double ms, int mpqn, int ppq)
    {
        return (long)(((ms * 1000.0) * ppq) / mpqn);
    }

    public static long msToTicks(double ms, float bpm, int ppq)
    {
