...
public class ViewAddSong extends View implements OnLongClickListener {
	...
	public ViewAddSong(Context context) {
		super(context);
		initView(context);
	}

	public ViewAddSong(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public ViewAddSong(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}
	
	private OnViewAddListener listener;
	public interface OnViewAddListener {
		public void OnActive(boolean bool , SongInfo song , String idSong , float x , float y);
		public void OnLockNotify();
		public void OnUnLockNotify();		
	}
	
	public void setOnViewAddListener(OnViewAddListener listener){
...
//	private Spannable wordtoSpan = null;
	...
	public void setSongName(String name , boolean isActive){		
 		this.textSong = name;
		this.isActive = isActive;
		this.wordtoSpan = new SpannableString(name);
...
//	private Spannable spanNemberID = new SpannableString("888000 | 33888");
	...
	public void setContentView(int position, SongInfo song){		
		this.spanNemberID = new SpannableString(convertIdSong(song.getId()));
		this.textLyric = song.getLyric();
		this.position = position;
		int id = song.getId();
		
		this.idSong = convertIdSong(id);
		...
		isClick = false;
			...
			this.textSinger = song.getSinger();
			this.textSong = song.getTitle();
