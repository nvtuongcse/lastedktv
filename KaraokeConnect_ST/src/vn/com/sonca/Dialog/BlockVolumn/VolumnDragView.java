...
public class VolumnDragView extends View {
	...
	public VolumnDragView(Context context) {
		super(context);
		initView(context);
	}

	public VolumnDragView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public VolumnDragView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}
	
	private OnVolumnDragViewListener listener;
	public interface OnVolumnDragViewListener {
		public void OnVolumnDrag(int value);
	}
	
	public void setOnVolumnDragViewListener(OnVolumnDragViewListener listener){
	...
	private int[] offsetCenter = new int[17];
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:{
			...
			if(listener != null){
				listener.OnVolumnDrag(valueView);
			}
		}break;	
		default: break;
		}		
