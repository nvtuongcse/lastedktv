...
public class LoadHotSongFromDatabase extends BaseLoadSong {
	
	private Context context;
	private String where;
	private MEDIA_TYPE typeMedia;
	
	public LoadHotSongFromDatabase(String where, ArrayList<Song> listSongs, int state2 , Context context) {
...
///////////////////////// - QUERY - ////////////////////////////
	...
	private Cursor DBSearch(String where, int offset, int sumData) {
		Cursor cursor = DBInterface.DBGetSongTypeIDCursor(context, where,
				SearchType.SEARCH_TYPE, typeMedia, DbHelper.SongType_HotSong, offset,
				sumData);
