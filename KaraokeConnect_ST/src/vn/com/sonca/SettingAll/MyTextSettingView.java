...
public class MyTextSettingView extends View {
	
	private Paint mainText = new Paint(Paint.ANTI_ALIAS_FLAG);
	
	public MyTextSettingView(Context context) {
		super(context);
		initView(context);
	}

	public MyTextSettingView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public MyTextSettingView(Context context, AttributeSet attrs, int defStyle) {
	...
	private String title = "Thoi gian tu dong tac mang hinh";
