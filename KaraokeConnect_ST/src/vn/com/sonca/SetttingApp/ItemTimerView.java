...
public class ItemTimerView extends View {
	...
	public ItemTimerView(Context context) {
		super(context);
		initView(context);
	}

	public ItemTimerView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public ItemTimerView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}

	private String name = "ACNOS";
	...
	private OnItemTimerListener listener;
	public interface OnItemTimerListener {
		public void OnTimerClick(int id , int tgian);
	}
	
	public void setOnItemTimerListener(OnItemTimerListener listener){
	...
	public void setPressed(boolean pressed) {
		...
		if(state != ENABLE){
			if(pressed == true){
				...
				if(listener != null){
					listener.OnTimerClick(this.getId(), tgiansleep);
				}
			}
		}
	}
	*/
	...
	private Sleep sleep;
	private int tgiansleep;
	public void setData(Sleep model) {
		this.sleep = model;
		name = model.getName();
		tgiansleep = model.getGiay();
