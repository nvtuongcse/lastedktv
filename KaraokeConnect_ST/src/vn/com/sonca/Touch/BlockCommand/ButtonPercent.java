...
public class ButtonPercent extends View {
	
	private TextPaint paintText = new TextPaint(Paint.ANTI_ALIAS_FLAG);
	
	public ButtonPercent(Context context) {
		super(context);
		initView(context);
	}

	public ButtonPercent(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public ButtonPercent(Context context, AttributeSet attrs, int defStyle) {
