...
public class ButtonVolumnOnOff extends View {
	
	private Paint paintMain = new Paint(Paint.ANTI_ALIAS_FLAG);
	private TextPaint textPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
	
	public ButtonVolumnOnOff(Context context) {
		super(context);
		initView(context);
	}

	public ButtonVolumnOnOff(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public ButtonVolumnOnOff(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}
	
	private OnVolumnOnOffCommandListener listener;
	public interface OnVolumnOnOffCommandListener{
	...
	public void setOnVolumnOnOffCommandListener(OnVolumnOnOffCommandListener listener){
	...
	protected void onDraw(Canvas canvas) {
		...
		if(MyApplication.intColorScreen == MyApplication.SCREEN_BLUE || MyApplication.intColorScreen == MyApplication.SCREEN_KTVUI){
			...
			String textState = getResources().getString(R.string.dialog_volumn_block_1);
			textPaint.setStyle(Style.FILL);
