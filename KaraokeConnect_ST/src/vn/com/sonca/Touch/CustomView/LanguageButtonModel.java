...
public class LanguageButtonModel extends View {
	
	private TextPaint paintText = new TextPaint(Paint.ANTI_ALIAS_FLAG);
	
	public LanguageButtonModel(Context context) {
		super(context);
		initView(context);
	}

	public LanguageButtonModel(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public LanguageButtonModel(Context context, AttributeSet attrs, int defStyle) {
