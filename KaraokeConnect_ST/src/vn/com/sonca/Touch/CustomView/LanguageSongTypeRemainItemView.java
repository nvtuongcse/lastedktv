...
public class LanguageSongTypeRemainItemView extends View {
	...
	public LanguageSongTypeRemainItemView(Context context) {
		super(context);
		initView(context);
	}

	public LanguageSongTypeRemainItemView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public LanguageSongTypeRemainItemView(Context context, AttributeSet attrs, int defStyle) {
