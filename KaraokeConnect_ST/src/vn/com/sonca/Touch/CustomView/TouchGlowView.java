...
public class TouchGlowView extends View {
	...
	public TouchGlowView(Context context) {
		super(context);
		initView(context);
	}

	public TouchGlowView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public TouchGlowView(Context context, AttributeSet attrs, int defStyle) {
