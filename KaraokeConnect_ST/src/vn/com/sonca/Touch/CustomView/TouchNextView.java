...
public class TouchNextView extends View {
	...
	public TouchNextView(Context context) {
		super(context);
		initView(context);
	}

	public TouchNextView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public TouchNextView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView(Context context) {
		...
		drawable = getResources().getDrawable(R.drawable.touch_mc_next_96x96);
		drawBG = getResources().getDrawable(R.drawable.touch_next_inactive);

		text = getResources().getString(R.string.main_left_7);
		...
		zlight_drawable = getResources().getDrawable(R.drawable.zlight_mc_next);
		zlight_drawBG = getResources().getDrawable(
				R.drawable.zlight_next_inactive);
	}
