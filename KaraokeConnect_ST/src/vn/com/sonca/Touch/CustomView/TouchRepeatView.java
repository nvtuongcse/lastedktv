...
public class TouchRepeatView extends View {
	...
	public TouchRepeatView(Context context) {
		super(context);
		initView(context);
	}

	public TouchRepeatView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public TouchRepeatView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView(Context context) {
		...
		drawable = getResources().getDrawable(R.drawable.touch_mc_repeat_96x96);
		drawBG = getResources().getDrawable(R.drawable.touch_repeat_inactive);
