...
public class TouchSongTypeFirstItemView extends View {
	...
	public TouchSongTypeFirstItemView(Context context) {
		super(context);
		initView(context);
	}

	public TouchSongTypeFirstItemView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public TouchSongTypeFirstItemView(Context context, AttributeSet attrs, int defStyle) {
