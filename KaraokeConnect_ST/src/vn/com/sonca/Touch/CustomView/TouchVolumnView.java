...
public class TouchVolumnView extends View {
	...
	public TouchVolumnView(Context context) {
		super(context);
		this.context = context;
		initView();
	}

	public TouchVolumnView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		initView();
	}

	public TouchVolumnView(Context context, AttributeSet attrs, int defStyle) {
