...
public class XoaVideoView extends View {
	...
	private OnXoaVideoViewListener listener;

	public interface OnXoaVideoViewListener {
		public void OnXoaVideo();
	}

	public void setOnXoaVideoViewListener(OnXoaVideoViewListener listener) {
		this.listener = listener;
	}

	public XoaVideoView(Context context) {
		super(context);
		initView(context);
	}

	public XoaVideoView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public XoaVideoView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView(Context context) {
		...
		drawable = getResources().getDrawable(R.drawable.mc_delete_96x96);
		drawBG = getResources().getDrawable(R.drawable.xoavideo_inactive);

		text = getResources().getString(R.string.msg_kara_7);
		...
		zlight_drawable = getResources().getDrawable(R.drawable.zlight_mc_delete_96x96);
		zlight_drawBG = getResources().getDrawable(
				R.drawable.zlight_xoavideo_xam);
	}
