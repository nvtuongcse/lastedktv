...
public class TouchAdapterSong extends ArrayAdapter<Song> {
	...
	public TouchAdapterSong(Context context, int resource, ArrayList<Song> arrayList, 
			String search , int language, TouchMainActivity mainActivity) {
