...
public class ItemSelectListView extends View {
	...
	public ItemSelectListView(Context context) {
		super(context);
		initView(context);
	}

	public ItemSelectListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public ItemSelectListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}

	private String name = "SONCA";
	private String list = "";
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		wr = hr;
		tamX = (int) (1.75*wr);
		rectDevice.set(0,0,0,0);
		
		nameS = (float) (0.4*h);
		nameX = (float) (0 + 1.8*wr);
		nameY = (float) (0.5*h + 0.3*nameS);
	...
	public void setData(String model, boolean active) {
		name = model;
		if (active == true) {
			state = ACTIVE;
		} else {
