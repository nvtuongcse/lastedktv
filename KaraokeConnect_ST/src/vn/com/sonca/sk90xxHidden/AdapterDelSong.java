...
import vn.com.sonca.sk90xxHidden.ViewDelSong.OnViewDelListener;
...
public class AdapterDelSong  extends ArrayAdapter<Song> {
	...
	private GlowViewHidden glowView = null;
	@Override
	public View getView(final int position, View convertView, ViewGroup parent) {
		ViewDelSong myGroupSong = null;
		if (convertView == null) {
			LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			convertView = inflater.inflate(R.layout.dialog_addsongdata_sk90xxhidden_del, null);
			myGroupSong = (ViewDelSong) convertView.findViewById(R.id.myGroupSong);
			glowView = (GlowViewHidden) convertView.findViewById(R.id.GlowView);
			...
			glowView = (GlowViewHidden) convertView.getTag(R.id.GlowView);
		}
		if (myGroupSong != null) {
