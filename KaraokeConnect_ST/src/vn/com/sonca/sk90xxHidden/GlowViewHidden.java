...
public class GlowViewHidden extends View {
	...
	public GlowViewHidden(Context context) {
		super(context);
		initView(context);
	}

	public GlowViewHidden(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public GlowViewHidden(Context context, AttributeSet attrs, int defStyle) {
