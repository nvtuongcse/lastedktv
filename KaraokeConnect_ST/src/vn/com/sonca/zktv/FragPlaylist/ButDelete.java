...
public class ButDelete extends View {
	
	public ButDelete(Context context) {
		super(context);
		initView(context);
	}

	public ButDelete(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public ButDelete(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView(Context context) {
		drawable = context.getResources().getDrawable(R.drawable.ktv_playlist_del);
