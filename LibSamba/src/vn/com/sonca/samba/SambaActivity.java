...
public class SambaActivity extends Activity {
    ...
    protected Map<String, SmbFile> REMOTE_PATHS = new LinkedHashMap<String, SmbFile>();
    ...
    protected final Map<String, SmbFile> SmbFileToMap(List<SmbFile> files) {
        ...
        Map<String, SmbFile> FILE = new LinkedHashMap<String, SmbFile>();
        Map<String, SmbFile> FOLDER = new LinkedHashMap<String, SmbFile>();
